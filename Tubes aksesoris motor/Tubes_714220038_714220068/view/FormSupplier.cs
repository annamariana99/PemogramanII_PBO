...
namespace Tubes_714220038_714220068.view
{
    public partial class FormSupplier : Form
    {
        ...
        public void Tampil()
        {
            ...
            DataSupplier.Columns[1].HeaderText = "Nama Sparepart";
        ...
        {
            if (nama_perusahaan.Text == "" || nama_sparepart.Text == "" || nomor_telepon.Text == "" || alamat.Text == "" || email.Text == "")
            {
            ...
            else
            {
                ...
                m_spl.Nama_sparepart = nama_sparepart.Text;
        ...
        private void DataSupplier_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            nama_sparepart.Text = DataSupplier.Rows[e.RowIndex].Cells[1].Value.ToString();
        ...
        private void tbCariData_TextChanged(object sender, EventArgs e)
        {
            ...
            DataSupplier.DataSource = koneksi.ShowData("SELECT * FROM supplier WHERE nama_perusahaan LIKE '%' '" + tbCariData.Text + "' '%' OR nama_sparepart LIKE '%' '" + tbCariData.Text + "' '%'");
        }
